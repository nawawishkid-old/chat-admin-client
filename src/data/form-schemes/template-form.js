...
const fieldSchemes = [nameFieldScheme, contentFieldScheme, openTagFieldScheme, closingTagFieldScheme, inputsFieldScheme];

export const templateBuilderFormScheme = {
  fields: fieldSchemes,
};

export default templateBuilderFormScheme;
